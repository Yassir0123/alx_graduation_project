...
const AddgrandCategory = ({ navigation }) => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('http://192.168.11.106/alx/alx/Components/Roles/interfaces/phpfolderv2/getcategoriesgrand.php');
  ...
  const uploadImage = async (imageUri, retryCount = 0) => {
    ...
    try {
      const responseImage = await fetch('http://192.168.11.106/alx/alx/Components/Roles/interfaces/phpfolderv2/uploadimage.php', {
        method: 'POST',
        body: formData,
        headers: {
  ...
  const handleAddCategory = async (retryCount = 0) => {
    if (addData && selectedImage) {
      ...
      try {
        ...
        const response = await axios.post('http://192.168.11.106/alx/alx/Components/Roles/interfaces/phpfolderv2/addcategoriegrand.php', {
          nomcat: addData,
          image: imageUrl,
        });
  ...
  const handleUpdateCategory = async (retryCount = 0) => {
    if (editData && selectedItem) {
      ...
      try {
        ...
        const response = await axios.post('http://192.168.11.106/alx/alx/Components/Roles/interfaces/phpfolderv2/updatecategoriegrand.php', {
          id: selectedItem,
          nomcat: editData,
          image: imageUrl,
        }, {
  ...
  const handleDeleteCategory = async (category) => {
    try {
      const response = await axios.post('http://192.168.11.106/alx/alx/Components/Roles/interfaces/phpfolderv2/deletecategoriegrand.php', {
