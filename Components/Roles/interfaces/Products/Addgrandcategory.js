...
const AddgrandCategory = ({ navigation }) => {
    ...
    if (addData && selectedImage) {
      try {
        ...
        if (imageResponseData.success) {
          const response = await axios.post('http://10.20.74.42/logo/Components/Roles/interfaces/phpfolderv2/addcategoriegrand.php', {
            nomcat: addData,
  ...
  const handleUpdateCategory = async () => {
    if (editData && selectedItem) {
      try {
        const response = await axios.post('http://10.20.74.42/logo/Components/Roles/interfaces/phpfolderv2/updatecategoriegrand.php', {
          id: selectedItem,
          nomcat: editData,
  ...
  const handleDeleteCategory = async (category) => {
    try {
      const response = await axios.post('http://10.20.74.42/logo/Components/Roles/interfaces/phpfolderv2/deletecategoriegrand.php', {
