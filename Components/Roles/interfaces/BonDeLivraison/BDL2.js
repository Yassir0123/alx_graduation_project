...
const BDL2 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('http://192.168.11.105/logo/Components/Roles/interfaces/phpfolderv2/getlivreur.php');
        const responses = await axios.get('http://192.168.11.105/logo/Components/Roles/interfaces/phpfolderv2/getidcmd2.php');
  ...
  console.log(selectedLivreurObj.id_livreur);
      ...
      const response = await axios.post(
        'http://192.168.11.105/logo/Components/Roles/interfaces/phpfolderv2/getcmdinfos.php',
        {
          id: selectedCommandeObj.id_commande, // Send only the ID value
        }
      );
      const responses = await axios.post(
        'http://192.168.11.105/logo/Components/Roles/interfaces/phpfolderv2/getlivreurbyid.php',
        {
      ...
      const responsed = await axios.get(
        'http://192.168.11.105/logo/Components/Roles/interfaces/phpfolderv2/newbon.php',
          ...
          {livreur && livreur.length > 0 ? (
            livreur.map((option) => (
              <Picker.Item
                ...
                label={option.id_livreur.toString()}
