...
const App = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await axios.post(
          'http://10.20.75.42/logo/Components/Roles/interfaces/phpfolderv2/getpay.php',
          { id: userId },
          { responseType: 'json' }
        );
  ...
  const handleCardPress = async (item) => {
    ...
    try {
      const response = await axios.post(
        'http://10.20.69.42/logo/Components/Roles/interfaces/phpfolderv2/getprodbybon.php',
