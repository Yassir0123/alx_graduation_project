    ...
    const fetchClientData = async () => {
      try {
        ...
        const response = await axios.post(
          'http://192.168.0.48/logo/Components/Roles/interfaces/phpfolderv2/getpaybybon.php',
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        >
          <View style={styles.headerContent}>
            <Image
              source={{ uri: 'https://i.pinimg.com/originals/32/b6/f2/32b6f2aeeb2d21c5a29382721cdc67f7.gif' }}
              style={styles.icon}
              resizeMode="contain"
            />
