      ...
      if (userId !== null) {
        ...
        if (responses.data.userData && responses.data.userData.length > 0) {
          const newFournisseurData = {
            idcmdcount: responses.data.userData[0].idcmdcount,
          ...
          console.log(newFournisseurData);
          navigation.navigate('Commande_Fournisseur', { FournisseurData: newFournisseurData });
        } else {
...
export default Ajout_Fournisseur;
