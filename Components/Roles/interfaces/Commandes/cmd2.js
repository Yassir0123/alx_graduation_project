...
const Item = ({ id, name, price, quantity, img, tva, onAddButtonPress }) => (
  <View style={styles.productCard}>
    <View style={styles.imageContainer}>
      <Image source={{ uri: `http://192.168.11.106/alx/alx/Components/Roles/interfaces/Products/${img}` }} style={styles.productImage} />
  ...
  useEffect(() => {
    const fetchClientData = async () => {
      try {
        ...
        'http://192.168.11.106/alx/alx/Components/Roles/interfaces/phpfolderv2/getallproducts.php',
          { responseType: 'json' }
        );
        ...
        'http://192.168.11.106/alx/alx/Components/Roles/interfaces/phpfolderv2/getcategoriesgrand.php',
          { responseType: 'json' }
        );
