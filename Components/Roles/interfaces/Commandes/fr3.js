...
const PlaceCommand = ({ route }) => {
  ...
  const { FournisseurData, product,selectedMainCategory,selectedSubCategory } = route.params;
  ...
  FournisseurData.action=1;
   navigation.navigate('Commande_Fournisseur',{FournisseurData}); // Navigate to ScheduleDelivery screen
  };
